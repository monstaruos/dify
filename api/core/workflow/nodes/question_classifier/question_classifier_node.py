...
from core.model_runtime.entities import LLMUsage, ModelPropertyKey, PromptMessage, PromptMessageRole
...
from core.workflow.nodes.llm import LLMNode, ModelInvokeCompleted
...
class QuestionClassifierNode(LLMNode):
    ...
    def _run(self) -> NodeRunResult:
        ...
        # fetch instruction
        instruction = (
            self._format_instruction(instruction=node_data.instruction, variable_pool=variable_pool)
